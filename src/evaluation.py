...
This module demonstrates two key payoffs of a modular pipeline:
  ...
  3. Feature importance
     ...
     students direct feedback on whether their feature work paid off.
"""
...
def plot_feature_importance(model, feature_names, model_name, output_dir=None, top_n=20):
    ...
    This plot is the payoff moment for feature engineering:
    students can see directly whether their engineered features
